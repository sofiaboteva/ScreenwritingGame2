export const moviepremiere = {
    "moviepremiereintro": {
        ...
        "text": "The day has finally come. It’s the premiere of your first movie—the one you were fired from two years ago... But that’s all in the past. Now, it’s time to enjoy the moment.",
    ...
    "screening": {
        "chapterId": "moviepremiere",
        "character": "InnerVoice",
        "text": "The lights dim, and the movie begins. It’s far from the story you imagined, half of it isn’t even yours. Honestly, you don’t even like it.  Still, your name is in the credits. ",
        "aspect": "hierarchisation, marginalisation",
    ...
    "afterpartyintro": {
        "chapterId": "moviepremiere",
        "character": "InnerVoice",
        "text": "The afterparty buzzes behind you, but out here under the night sky, it’s quiet. Your agent joins you with a glass of champagne, a rare moment of calm after the chaos of the premiere.",
        "leftAnswer": {
    ...
    "sequel": {
        "chapterId": "moviepremiere",
        "character": "Agent",
        "text": "Actually, the executive just asked me if you'd be interested in a sequel. He's ready to close the deal right away.",
        "leftAnswer": {
    ...
    "theend": {
        "chapterId": "moviepremiere",
        "character": "InnerVoice",
        "text": "It was a fun night. But have you truly made it? Not yet. The journey ahead is long and full uncertainty. But as you drift to sleep, your dreams reveal glimpses of your future.",
        "comment": "No real choice",
        "leftAnswer": {
            "text": "Let’s find out.",
            "nextScene": "win"
